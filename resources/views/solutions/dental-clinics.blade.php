        ...
        <div class="apple-split">
            ...
            <div class="apple-split-media fade-in-up" style="animation-delay: 0.15s;">
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden p-1">
                    <img src="@asset('images/clinic-dashboard-new.webp')" alt="DentalSO Connect Clinic View - Affordable dental lab management software, free trial" class="apple-split-img rounded-xl" loading="lazy">
                </div>
            </div>
        </div>
    </div>
