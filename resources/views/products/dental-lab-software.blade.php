...
<section class="apple-hero relative overflow-hidden bg-[var(--apple-white)]">
    <div class="apple-container text-center relative z-10">
        ...
        <div class="apple-hero-img-wrapper fade-in-up" style="animation-delay: 0.2s;">
            <img src="@asset('images/dental-lab-software-hero.webp')" alt="DentalSO Platform - Affordable dental lab management software, free trial" class="apple-hero-img w-full max-w-5xl mx-auto mt-12 rounded-2xl" loading="lazy">
        </div>
    </div>
</section>
    ...
    <div class="apple-container">
        <div class="apple-split">
            ...
            <div class="apple-split-media fade-in-up md:fade-delay-1">
                <img src="@asset('images/clinic-dashboard-new.webp')" alt="Dental Lab Software dashboard - Affordable dental lab management software, free trial" class="apple-split-img rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.08)]" loading="lazy">
            </div>
        </div>
    </div>
</section>
