        ...
        <div class="apple-split">
            ...
            <div class="apple-split-media fade-in-up" style="animation-delay: 0.15s;">
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden p-1">
                    <img src="@asset('images/mes-dashboard-live.webp')" alt="DentalSO MES — Real-time production dashboard - Affordable dental lab management software, free trial" class="apple-split-img rounded-xl" loading="lazy">
                </div>
            </div>
        </div>
    </div>
...
<section class="apple-section bg-[#f5f5f7]">
    <div class="apple-container">
        <div class="apple-split apple-split--reverse">
            ...
            <div class="apple-split-media fade-in-up" style="animation-delay: 0.15s;">
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden p-1">
                    <img src="@asset('images/clinic-dashboard-new.webp')" alt="DentalSO MES — Priority scheduling dashboard - Affordable dental lab management software, free trial" class="apple-split-img rounded-xl" loading="lazy">
                </div>
            </div>
        </div>
    </div>
